...
def get_link_prediction_args():
    ...
    parser.add_argument('-lr_decay_step', dest='lr_decay_step', default=30, type=int, help='lr decay step')
    parser.add_argument('-lr_decay_factor', dest='lr_decay_factor', default=0.9, type=float, help='lr decay factor')
    parser.add_argument('--weight_decay', type=float, default=0.005, help='weight decay')
    parser.add_argument('--patience', type=int, default=110, help='patience for early stopping')
    ...
    parser.add_argument('--num_ta_structural_heads', type=str, default='16',
                        help='TAS attention layer config: # attention heads in each TAS attention layer. allow for multiheads for each layer')
    parser.add_argument('--ta_structural_layer_dims', type=str, default='128',
                        help='TAS attention layer config: # dimension of each spatial embedding layer')
    parser.add_argument('--ta_structural_drop', type=float, default=0.1,
   ...
   # arguments for structural aware temporal attention layera
    ...
    parser.add_argument('--sa_temporal_layer_dims', type=str, default='128',
                        help='SAT attention layer config: # dimension of the neighbor time attention layer')
    parser.add_argument('--sa_temporal_drop', type=float, default=0.5,
    ...
    parser.add_argument('--temporal_layer_dims', type=str, default='128',
    ...
    parser.add_argument('--consist_weight', type=float, default=10, help='Weight for consistency loss')
